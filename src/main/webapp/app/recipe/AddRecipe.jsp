                    ...
                    <div class="mt-4 ml-4 mr-4">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7"><textarea class="w-100 p-1" rows="5" name="disc" value=""></textarea></td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" type="number" value="" name="prepTime">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea class="w-100 p-1" rows="10" name="prep" value=""></textarea>
                            </div>
                            <div class="col-2"></div>

                            <div class="col-5 p-4">
                                <textarea class="w-100 p-1" rows="10" name="igred" value=""></textarea>
                            </div>
                        </div>
                    </div>
                </form>
